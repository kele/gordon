...
W chwili projektowania kompilatora języka \textsc{Gordon} na rynku dominowały następujące metody wytwarzania szybkiego i niezawodnego oprogramowania współbieżnego:
\begin{itemize}
    ...
    \item \emph{Software transactional memory} -- wykorzystanie techniki programowania, która nie wykorzystuje muteksów, więc nie występują zakleszczenia.
\end{itemize}
