...
\noindent Użytkownikami kompilatora \textsc{Gordon} są programiści, którzy tworzą oprogramowanie współbieżne. Są oni zaznajomieni z takimi pojęciami jak wzajemne wykluczanie czy zagłodzenie.
...
\begin{itemize}
    ...
    \item \emph{Metoda formalisty} -- posiadając model teoretyczny maszyny odtwarzamy program z jego formalnej specyfikacji.
    \item \emph{Pamięć transakcyjna} -- wykorzystanie techniki programowania, która nie wykorzystuje muteksów pozwala na uniknięcie zakleszczeń.
\end{itemize}
~\\
