...
Język \textsc{Gordon} jest narzędziem służącym do tworzenia oprgramowania wydajnego, współbieżnego oraz bezpiecznego. 
...
\noindent System oparty na jądrze \textsc{Linux} udostępniający interfejs \textsc{pthreads}.
