...
\section{Wstęp}
Gramatykę języka \textsc{Gordon} prezentujemy w formacie BFN\footnote{\emph{Backus-Naur Form}}.
Poniższa gramatyka będzie podstawą do implementacji modułu analizy składniowej i leksykalnej.
